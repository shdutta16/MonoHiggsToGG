...
fitterFormatting("$dnnBins_mA200","$indir","$outdir","sig",0, "nTuple_2HDMa_mA200_ma150_skimmedTree.root",	"sig_2HDMa_mA200_ma150")
...
fitterFormatting("$dnnBins_mA300","$indir","$outdir","sig",0, "nTuple_2HDMa_mA300_ma150_skimmedTree.root",	"sig_2HDMa_mA300_ma150")
...
fitterFormatting("$dnnBins_mA400","$indir","$outdir","sig",0, "nTuple_2HDMa_mA400_ma150_skimmedTree.root",	"sig_2HDMa_mA400_ma150")
...
fitterFormatting("$dnnBins_mA500","$indir","$outdir","sig",0, "nTuple_2HDMa_mA500_ma150_skimmedTree.root",	"sig_2HDMa_mA500_ma150")
...
fitterFormatting("$dnnBins_mA600","$indir","$outdir","sig",0, "nTuple_2HDMa_mA600_ma150_skimmedTree.root",	"sig_2HDMa_mA600_ma150")
...
fitterFormatting("$dnnBins_mA700","$indir","$outdir","sig",0, "nTuple_2HDMa_mA700_ma150_skimmedTree.root",	"sig_2HDMa_mA700_ma150")

fitterFormatting("$dnnBins_mA700","$indir","$outdir","bkg",0, "nTuple_VHToGG_skimmedTree.root",	"VHToGG_mA700")
fitterFormatting("$dnnBins_mA700","$indir","$outdir","bkg",0, "nTuple_VBFHToGG_skimmedTree.root",	"VBFHToGG_mA700")
fitterFormatting("$dnnBins_mA700","$indir","$outdir","bkg",0, "nTuple_ttHJetToGG_skimmedTree.root",	"ttHJetToGG_mA700")
fitterFormatting("$dnnBins_mA700","$indir","$outdir","bkg",0, "nTuple_GluGluHToGG_skimmedTree.root",	"GluGluHToGG_mA700")

fitterFormatting("$dnnBins_mA700","$indir","$outdir","bkg",0, "nTuple_DiPhotonJetsBox_skimmedTree.root",  "DiPhoton_mA700")
fitterFormatting("$dnnBins_mA700","$indir","$outdir","bkg",0, "nTuple_QCD_skimmedTree.root",		    "QCD_mA700")
fitterFormatting("$dnnBins_mA700","$indir","$outdir","bkg",0, "nTuple_GJet_skimmedTree.root",             "GJets_mA700")
fitterFormatting("$dnnBins_mA700","$indir","$outdir","bkg",0, "nTuple_DYJetsToLL_skimmedTree.root",	    "DYJetsToLL_mA700")

fitterFormatting("$dnnBins_mA700","$indir","$outdir","bkg",0, "nTuple_TTGJets_skimmedTree.root",    "TTGJets_mA700")
fitterFormatting("$dnnBins_mA700","$indir","$outdir","bkg",0, "nTuple_TTGG_0Jets_skimmedTree.root", "TTGG_0Jets_mA700")
fitterFormatting("$dnnBins_mA700","$indir","$outdir","bkg",0, "nTuple_TTJets_skimmedTree.root",     "TTJets_mA700")
fitterFormatting("$dnnBins_mA700","$indir","$outdir","bkg",0, "nTuple_TGJets_skimmedTree.root",     "TGJets_mA700")

fitterFormatting("$dnnBins_mA700","$indir","$outdir","bkg",0, "nTuple_TTWJetsToLNu_skimmedTree.root", "TTWJetsToLNu_mA700")

fitterFormatting("$dnnBins_mA700","$indir","$outdir","data",0,"nTuple_DoubleEG_skimmedTree.root",	"Data_mA700")



fitterFormatting("$dnnBins_mA800","$indir","$outdir","sig",0, "nTuple_2HDMa_mA800_ma150_skimmedTree.root",	"sig_2HDMa_mA800_ma150")

fitterFormatting("$dnnBins_mA800","$indir","$outdir","bkg",0, "nTuple_VHToGG_skimmedTree.root",	"VHToGG_mA800")
fitterFormatting("$dnnBins_mA800","$indir","$outdir","bkg",0, "nTuple_VBFHToGG_skimmedTree.root",	"VBFHToGG_mA800")
fitterFormatting("$dnnBins_mA800","$indir","$outdir","bkg",0, "nTuple_ttHJetToGG_skimmedTree.root",	"ttHJetToGG_mA800")
fitterFormatting("$dnnBins_mA800","$indir","$outdir","bkg",0, "nTuple_GluGluHToGG_skimmedTree.root",	"GluGluHToGG_mA800")

fitterFormatting("$dnnBins_mA800","$indir","$outdir","bkg",0, "nTuple_DiPhotonJetsBox_skimmedTree.root",  "DiPhoton_mA800")
fitterFormatting("$dnnBins_mA800","$indir","$outdir","bkg",0, "nTuple_QCD_skimmedTree.root",		    "QCD_mA800")
fitterFormatting("$dnnBins_mA800","$indir","$outdir","bkg",0, "nTuple_GJet_skimmedTree.root",             "GJets_mA800")
fitterFormatting("$dnnBins_mA800","$indir","$outdir","bkg",0, "nTuple_DYJetsToLL_skimmedTree.root",	    "DYJetsToLL_mA800")

fitterFormatting("$dnnBins_mA800","$indir","$outdir","bkg",0, "nTuple_TTGJets_skimmedTree.root",    "TTGJets_mA800")
fitterFormatting("$dnnBins_mA800","$indir","$outdir","bkg",0, "nTuple_TTGG_0Jets_skimmedTree.root", "TTGG_0Jets_mA800")
fitterFormatting("$dnnBins_mA800","$indir","$outdir","bkg",0, "nTuple_TTJets_skimmedTree.root",     "TTJets_mA800")
fitterFormatting("$dnnBins_mA800","$indir","$outdir","bkg",0, "nTuple_TGJets_skimmedTree.root",     "TGJets_mA800")

fitterFormatting("$dnnBins_mA800","$indir","$outdir","bkg",0, "nTuple_TTWJetsToLNu_skimmedTree.root", "TTWJetsToLNu_mA800")

fitterFormatting("$dnnBins_mA800","$indir","$outdir","data",0,"nTuple_DoubleEG_skimmedTree.root",	"Data_mA800")


fitterFormatting("$dnnBins_mA900","$indir","$outdir","sig",0, "nTuple_2HDMa_mA900_ma150_skimmedTree.root",	"sig_2HDMa_mA900_ma150")

fitterFormatting("$dnnBins_mA900","$indir","$outdir","bkg",0, "nTuple_VHToGG_skimmedTree.root",	"VHToGG_mA900")
fitterFormatting("$dnnBins_mA900","$indir","$outdir","bkg",0, "nTuple_VBFHToGG_skimmedTree.root",	"VBFHToGG_mA900")
fitterFormatting("$dnnBins_mA900","$indir","$outdir","bkg",0, "nTuple_ttHJetToGG_skimmedTree.root",	"ttHJetToGG_mA900")
fitterFormatting("$dnnBins_mA900","$indir","$outdir","bkg",0, "nTuple_GluGluHToGG_skimmedTree.root",	"GluGluHToGG_mA900")

fitterFormatting("$dnnBins_mA900","$indir","$outdir","bkg",0, "nTuple_DiPhotonJetsBox_skimmedTree.root",  "DiPhoton_mA900")
fitterFormatting("$dnnBins_mA900","$indir","$outdir","bkg",0, "nTuple_QCD_skimmedTree.root",		    "QCD_mA900")
fitterFormatting("$dnnBins_mA900","$indir","$outdir","bkg",0, "nTuple_GJet_skimmedTree.root",             "GJets_mA900")
fitterFormatting("$dnnBins_mA900","$indir","$outdir","bkg",0, "nTuple_DYJetsToLL_skimmedTree.root",	    "DYJetsToLL_mA900")

fitterFormatting("$dnnBins_mA900","$indir","$outdir","bkg",0, "nTuple_TTGJets_skimmedTree.root",    "TTGJets_mA900")
fitterFormatting("$dnnBins_mA900","$indir","$outdir","bkg",0, "nTuple_TTGG_0Jets_skimmedTree.root", "TTGG_0Jets_mA900")
fitterFormatting("$dnnBins_mA900","$indir","$outdir","bkg",0, "nTuple_TTJets_skimmedTree.root",     "TTJets_mA900")
fitterFormatting("$dnnBins_mA900","$indir","$outdir","bkg",0, "nTuple_TGJets_skimmedTree.root",     "TGJets_mA900")

fitterFormatting("$dnnBins_mA900","$indir","$outdir","bkg",0, "nTuple_TTWJetsToLNu_skimmedTree.root", "TTWJetsToLNu_mA900")

fitterFormatting("$dnnBins_mA900","$indir","$outdir","data",0,"nTuple_DoubleEG_skimmedTree.root",	"Data_mA900")
