...
dnnBins_mA200="0.03,0.05,0.1,0.2,0.39,0.75,0.93,0.98,0.99378,0.99835,1"
dnnBins_mA300="0.03,0.04,0.09,0.13,0.27,0.45,0.71,0.91,0.98,0.99183,1"
dnnBins_mA400="0.07,0.19,0.42,0.64,0.82,0.89,0.98,0.99285,0.99751,0.99885,1"
dnnBins_mA500="0.19,0.23,0.57,0.83,0.95,0.98,0.99228,0.99581,0.99845,0.99964,1"
dnnBins_mA600="0.41,0.57,0.80,0.93,0.98,0.99285,0.99733,0.99846,0.99964,0.99996,1"


#outdir="DNN_ntuples4fit_pho_newSig_${addname}_dnnBins_"${str_dnnBins}
outdir="DNN_ntuples4fit_pho_newSig_${addname}_dnnBins"
...
fitterFormatting("$dnnBins_mA500","$indir","$outdir","data",0,"nTuple_DoubleEG_skimmedTree.root",	"Data")
