...
def run(): 
    ...
    cats = ["mva_0.00:all","mva_0.05:all","mva_0.10:all","mva_0.15:all"]
...
def formatting(opts,tree_t,sampletype,infile,cuts,cats):
    ...
    print("Formating sample: %s"%fOrigName)
    ...
    tOrig.SetBranchAddress("chiso1",AddressOf(DiPhotonTree,'chiso1'))
    tOrig.SetBranchAddress("chiso2",AddressOf(DiPhotonTree,'chiso2'))
